...
function Binder:GetClassAddedSignal()
	...
	self._classAddedSignal = GoodSignal.new() -- :fire(class, inst)
...
function Binder:GetClassRemovingSignal()
	...
	self._classRemovingSignal = GoodSignal.new() -- :fire(class, inst)
...
function Binder:GetClassRemovedSignal()
	...
	self._classRemovedSignal = GoodSignal.new() -- :fire(class, inst)
