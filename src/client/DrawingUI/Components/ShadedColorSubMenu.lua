...
function ShadedColorSubMenu:render()
  ...
  local shadeGrid
  do
    for i, colorShadeTable in ipairs(colorPalette) do
      local selected = selectedShadedColor.BaseName == colorShadeTable.Name

      baseColorButtons[colorShadeTable.Name] = e(ColorButton, {
        Color = selected and selectedShadedColor.Color or colorShadeTable.BaseColor,
        LayoutOrder = i,
        Selected = selected,
        OnClick = function()
          onShadedColorSelect({
            BaseName = colorShadeTable.Name,
            BaseColor = colorShadeTable.BaseColor,
      ...
      local shadeButtons = {}
      if colorShadeTable.Name == selectedShadedColor.BaseName then
